...
WRAPPED_ARWEAVE_MIN_QUANTITY = 25000000000   -- 25 Billion
WRAPPED_ARWEAVE_CAP_QUANTITY = 25000000000   -- 25 Billion
...
Handlers.add(
  ...
  function(msg)
    ...
    message = message .. ' Go to ao-bazar.g8way.io or www.permaswap.network/#/ao/LLAMA-AR to view and trade your ao tokens.'
    Send({
      Target = LLAMA_FED_CHAT_PROCESS,
      Tags = {
        Action = 'ChatMessage',
